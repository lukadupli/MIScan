...
class ResolutionSelectorProxyApi extends PigeonApiResolutionSelector {
  ...
  public ResolutionSelector pigeon_defaultConstructor(
    ...
    if (resolutionStrategy != null) {
      ...
      // MIScan patch: make "highest available" mean it. By default CameraX only
      // picks from sizes that sustain 20 fps, which on burst-capable cameras hides
      // the full-resolution sizes (4080x3060 runs at 15 fps on a SM-A137F).
